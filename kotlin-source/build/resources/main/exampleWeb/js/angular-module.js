...
app.controller('ModalInstanceCtrl', function ($http, $location, $uibModalInstance, $uibModal, apiBaseURL, peers) {
    ...
    modalInstance.create = () => {
        if (invalidFormInput()) {
            ...
            const bl = {
                securityId: modalInstance.form.securityId,
                cashDividendValue: modalInstance.form.cashDividendValue,
                securityName: modalInstance.form.securityName,
                announcementDate: modalInstance.form.announcementDate,
            };
    ...
    function invalidFormInput() {
        return (modalInstance.form.securityId === undefined) || (modalInstance.form.shippingCompany === undefined) || (modalInstance.form.importerBank === undefined);
    }
});
