...
# Bill of Lading CorDapp

Welcome to the Bill of Lading CorDapp which is based on the [CorDapp tutorial](http://docs.corda.net/tutorial-cordapp.html) found on
the Corda docsite.
...
## The Bill of Lading CorDapp

The Bill of Lading CorDapp implements a basic scenario where a exporter wishes to
submit a Bill of Lading to a importer's bank via a shipping company. The scenario defines four nodes:

* **Controller** which hosts the network map service and validating notary
  service.
* **NodeA** who is the exporter.
* **NodeB** who is the shipping company.
* **NodeC** who is the importer's bank.

NodeA can generate bill of lading. The flows used to facilitate the agreement process 
always result in an agreement with the shipping company and the importer's bank as long as the BL meets the 
contract constraints which are defined in `BLContract`.
...
## Build the Bill of Lading CorDapp

**NOTE: Building the Bill of Lading CorDapp from master WILL fail without 
...
This will build the Bill of Lading CorDapp. Any changes you wish to make to the 
